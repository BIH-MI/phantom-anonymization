...
@NoArgsConstructor
@ToString
public class EnhancedBLikeness extends PrivacyModel {

    /** Parameter for the privacy model */
    private double b;

    /**
     * Optional list of attributes to which EnhancedBLikeness will be applied. If left empty all sensitive
    ...
    public Collection<PrivacyCriterion> getPrivacyCriterion(Data data) {
        ...
        for (String sensitiveAttribute : sensitiveAttributes) {
            privacyCriterionList.add(new org.deidentifier.arx.criteria.EnhancedBLikeness(
                    sensitiveAttribute,
                    b));
        }
