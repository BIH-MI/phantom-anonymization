...
@NoArgsConstructor
@ToString
public class EqualDistanceTCloseness extends PrivacyModel {

    /** Parameter for the privacy model */
    private double t;

    /**
     * Optional list of attributes to which EqualDistanceTCloseness will be applied. If left empty all sensitive
    ...
    public Collection<PrivacyCriterion> getPrivacyCriterion(Data data) {
        ...
        for (String sensitiveAttribute : sensitiveAttributes) {
            privacyCriterionList.add(new org.deidentifier.arx.criteria.EqualDistanceTCloseness(
                    sensitiveAttribute,
                    t));
        }
