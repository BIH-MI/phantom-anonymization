...
@NoArgsConstructor
@ToString
public class EntropyLDiversity extends PrivacyModel {

    /** Parameter for the privacy model */
    private int l;

    /**
     * Optional list of attributes to which EntropyLDiversity will be applied. If left empty all sensitive
    ...
    public Collection<PrivacyCriterion> getPrivacyCriterion(Data data) {
        ...
        for (String sensitiveAttribute : sensitiveAttributes) {
            privacyCriterionList.add(new org.deidentifier.arx.criteria.EntropyLDiversity(sensitiveAttribute, l));
        }
