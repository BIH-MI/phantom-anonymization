...
public class HierarchyUtils {
    ...
    /**
     * Reads the contents of a CSV file into a list of rows, where each row is represented
     * as an array of strings. The specified delimiter is used to split the values in each row.
     *
     * @param filePath  The path to the CSV file.
     * @param delimiter The delimiter used to separate fields in the CSV.
     * @return A list of string arrays, each representing a row in the CSV file.
     * @throws IOException  If an I/O error occurs while reading the file.
     * @throws CsvException If the CSV is malformed or cannot be parsed.
     */
    ...
    /**
     * Writes a list of rows to a CSV file, where each row is provided as an array of strings.
     * The specified delimiter is used to separate the fields within each row in the output file.
     *
     * @param data      The data to write, where each string array is a row.
